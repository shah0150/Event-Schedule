...
class ScheduleTableViewController: UITableViewController, eventPassing {
    ...
    override func viewDidLoad() {
        ...
        myNewSchedule.addNewEvent(title: "Class", description: "Power Outage", dateString: "2016/11/14 20:20")
    }
...
//cell.textLabel?.text = myNewSchedule.eventArray[indexPath.row]
//        
//    cell.textLabel?.text =
